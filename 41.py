...
GIF_PATH = None  # Set to a valid GIF path if you want playback
...
if GIF_PATH:
    ...
    print("ℹ️ GIF playback disabled (no GIF_PATH provided).")
        ...
        if two_hands_detected_time is not None:
            ...
            if time_since_detection >= TWO_HANDS_DELAY:
                ...
                if gif_frames:
                    ...
                    print("🎉 Gesture detected (GIF playback disabled).")
